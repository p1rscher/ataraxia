...
class VoiceXPRequirements(commands.Cog):
    ...
    requirements_group = app_commands.Group(
    ...
    async def view_requirements(self, interaction: discord.Interaction):
        ...
        requirements = await db.get_voice_xp_requirements(interaction.guild_id)
    ...
    @app_commands.checks.has_permissions(administrator=True)
    async def set_afk_requirement(self, interaction: discord.Interaction, allow: bool):
        """Set AFK requirement for Voice XP"""
        
        # Note: allow=True means they CAN be AFK, so require_non_afk=False
        require_non_afk = not allow
        
        await db.set_voice_xp_requirement(interaction.guild_id, 'require_non_afk', require_non_afk)
    ...
    @app_commands.checks.has_permissions(administrator=True)
    async def set_deaf_requirement(self, interaction: discord.Interaction, allow: bool):
        ...
        await db.set_voice_xp_requirement(interaction.guild_id, 'require_non_deaf', require_non_deaf)
    ...
    @app_commands.checks.has_permissions(administrator=True)
    async def set_muted_requirement(self, interaction: discord.Interaction, allow: bool):
        ...
        await db.set_voice_xp_requirement(interaction.guild_id, 'require_non_muted', require_non_muted)
    ...
    @app_commands.checks.has_permissions(administrator=True)
    async def set_alone_requirement(self, interaction: discord.Interaction, allow: bool):
        ...
        await db.set_voice_xp_requirement(interaction.guild_id, 'require_others_in_channel', require_others_in_channel)
    ...
    @app_commands.checks.has_permissions(administrator=True)
    async def reset_requirements(self, interaction: discord.Interaction):

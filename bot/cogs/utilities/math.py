...
class MathCog(commands.Cog):
    ...
    @commands.hybrid_group(name="math", description="Mathematical operations")
    async def math_group(self, ctx: commands.Context):
        pass

    @math_group.command(name="help")
    async def math_help(self, interaction: commands.Context):
    ...
    async def calculate(self, interaction: commands.Context, expression: str):
    ...
    async def solve_equation(self, interaction: commands.Context, equation: str):
        ...
        try:
            ...
            if not variables:
                await interaction.send("❌ No variables found in the equation.", ephemeral=True)
                return
            ...
            if not solutions:
                await interaction.send("❌ No solution found.", ephemeral=True)
                return
    ...
    async def solve_system(self, interaction: commands.Context, equations: str):
        ...
        try:
            ...
            if not all_variables:
                await interaction.send("❌ No variables found in the equations.", ephemeral=True)
                return
            ...
            if not solutions:
                await interaction.send("❌ No solution found for this system.", ephemeral=True)
                return
    ...
    async def derivative(self, interaction: commands.Context, function: str, variable: str = "x"):
    ...
    async def integrate(self, interaction: commands.Context, function: str, variable: str = "x", definite: str = None):
    ...
    async def sum_formula(self, interaction: commands.Context, expression: str, variable: str = "n", start: str = "1", end: str = "10"):
    ...
    async def limit(self, interaction: commands.Context, function: str, variable: str = "x", point: str = "0", direction: str = None):
    ...
    @commands.hybrid_group(name="matrix", description="Matrix operations", parent=math_group)
    async def matrix_group(self, ctx: commands.Context):
        pass
    ...
    async def matrix_multiply(self, interaction: commands.Context, matrix_a: str, matrix_b: str):
    ...
    async def matrix_determinant(self, interaction: commands.Context, matrix: str):
        """Calculate the determinant of a matrix"""
        try:
            mat = self._parse_matrix(matrix)
            
            if mat.rows != mat.cols:
                await interaction.send("❌ Matrix must be square to calculate determinant.", ephemeral=True)
                return
    ...
    @app_commands.describe(matrix="Matrix (e.g., 1,2;3,4)")
    async def matrix_inverse(self, interaction: commands.Context, matrix: str):
        """Calculate the inverse of a matrix"""
        try:
            mat = self._parse_matrix(matrix)
            
            if mat.rows != mat.cols:
                await interaction.send("❌ Matrix must be square to calculate inverse.", ephemeral=True)
                return
            
            if mat.det() == 0:
                await interaction.send("❌ Matrix is singular (determinant = 0), no inverse exists.", ephemeral=True)
                return
    ...
    async def matrix_eigenvalues(self, interaction: commands.Context, matrix: str):
        """Calculate eigenvalues and eigenvectors of a matrix"""
        try:
            mat = self._parse_matrix(matrix)
            
            if mat.rows != mat.cols:
                await interaction.send("❌ Matrix must be square to calculate eigenvalues.", ephemeral=True)
                return
